 ...
 */
public class EmployeeTrainingReport extends AbstractPageBean {

    private ArrayList<EmployeeTrainingReportList> listOfTableDate = new ArrayList<EmployeeTrainingReportList>();
     ...
     */
    public EmployeeTrainingReport() {
    }

    public ArrayList<EmployeeTrainingReportList> getListOfTableDate() {
        return listOfTableDate;
    }

    public void setListOfTableDate(ArrayList<EmployeeTrainingReportList> listOfTableDate) {
        this.listOfTableDate = listOfTableDate;
    }

    public class EmployeeTrainingReportList {
        ...
        public EmployeeTrainingReportList(String employeeId,
                String employeeName,
                String religion,
                String hireDate,
                String dateOfBirth,
    ...
    private void loadTableDate() {
        try {
            ...
            ArrayList<HashMap> listOfDate = profileReportManager.selectEmployeeTraining();
            for (HashMap hm : listOfDate) {
                EmployeeTrainingReportList employeeReportList = new EmployeeTrainingReportList(
                        ...
                        hm.get("TRAININGORCOURSE_NAME").toString(),
                        hm.get("AGE").toString(),
