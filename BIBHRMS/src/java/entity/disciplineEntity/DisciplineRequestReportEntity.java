 ...
 */
public class DisciplineRequestReportEntity extends ConnectionManager {
  ...
  //  ReportCriteraManager criteraManager=new ReportCriteraManager();
    ...
    public OracleCachedRowSet readAllDiscipline() throws SQLException {
        ...
        String _selectquery = "SELECT  dis.offence_date," +
                ...
                " epf.EMP_ID AS Requester_ID,  " +
                " epf.first_name AS Requester_First_Name, " +
                " epf.middle_name AS Requester_Middle_Name," +
                " epf.last_name  AS Requester_Last_Name,  " +
                " epf.department_name AS Requester_Department," +
                " epf.JOB_NAME AS Requester_Job_Position" +
...
//                " ON epf.EMP_ID =dis.REQUESTER_ID " +
