...
<!-- 
    Document   : TrainingApproveReport
    Created on : Jul 16, 2012, 11:56:01 AM
    Author     : tomgenial 
-->
            ...
            <body id="outputBody1" style="-rave-layout: grid">
                <ice:form id="form1">
                    <h:dataTable border="1" headerClass="list-header" id="dataTable1" rowClasses="list-row-even,list-row-odd"
                        style="font-size: 12px; left: 0px; top: 144px; position: absolute" value="#{Training$TrainingApproveReport.trainingApproveReport}" var="currentRow">
                        <h:column id="clmnId">
                        ...
                        <h:column id="clmnName">
                            <h:outputText id="outputText2" value="#{currentRow['fullName']}"/>
                            <f:facet name="header">
                        ...
                        <h:column id="clmndepartmentPath">
                            <h:outputText id="outputText3" value="#{currentRow['departmentPath']}"/>
                            <f:facet name="header">
                        ...
                        <h:column id="clmnjobDescription">
                            <h:outputText id="outputText4" value="#{currentRow['jobDescription']}"/>
                            <f:facet name="header">
                        ...
                        <h:column id="clmncategoryName">
                            <h:outputText id="outputText5" value="#{currentRow['categoryName']}"/>
                            <f:facet name="header">
                        ...
                        <h:column id="clmntrainingName">
                            <h:outputText id="outputText6" value="#{currentRow['trainingName']}"/>
                            <f:facet name="header">
                        ...
                        <h:column id="clmnappliedDate">
                            <h:outputText id="outputText7" value="#{currentRow['appliedDate']}"/>
                            <f:facet name="header">
                        ...
                        <h:column id="clmnstartDate">
                            <h:outputText id="outputText8" value="#{currentRow['startDate']}"/>
                            <f:facet name="header">
                                <h:outputText id="startDate" style="font-family: 'Visual Geez Unicode'; font-size: 12px" value="ከ"/>
                            </f:facet>
                        </h:column>
                        <h:column id="clmnendDate">
                            <h:outputText id="outputText9" value="#{currentRow['endDate']}"/>
                            <f:facet name="header">
                                <h:outputText id="endDate" style="font-family: 'Visual Geez Unicode'; font-size: 12px" value="እስከ"/>
                            </f:facet>
                        </h:column>
                        <h:column id="clmnnoOfDays">
                            <h:outputText id="outputText10" value="#{currentRow['noOfDays']}"/>
                            <f:facet name="header">
                                <h:outputText id="noOfDays" style="font-family: 'Visual Geez Unicode'; font-size: 12px" value="የሥልጠና ቀን ብዛት"/>
                            </f:facet>
                        </h:column>
                        <h:column id="clmnaward">
                            <h:outputText id="outputText11" value="#{currentRow['award']}"/>
                            <f:facet name="header">
                                <h:outputText id="award" style="font-family: 'Visual Geez Unicode'; font-size: 12px" value="የተገኘው ማስረጃ"/>
                            </f:facet>
                        </h:column>
                        <h:column id="clmninstitutionName">
                            <h:outputText id="outputText12" value="#{currentRow['institutionName']}"/>
                            <f:facet name="header">
                                <h:outputText id="institutionName" style="font-family: 'Visual Geez Unicode'; font-size: 12px" value="ሥልጠናው የሚሰጥበት ቦታ"/>
                            </f:facet>
                        </h:column>
                        <h:column id="clmntrainerName">
                            <h:outputText id="outputText13" value="#{currentRow['trainerName']}"/>
                            <f:facet name="header">
                                <h:outputText id="trainerName" style="font-family: 'Visual Geez Unicode'; font-size: 12px" value="የአሰልጣኙ ስም"/>
                            </f:facet>
                        </h:column>
                    </h:dataTable>
                </ice:form>
