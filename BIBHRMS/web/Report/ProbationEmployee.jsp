...
<jsp:root version="2.1" xmlns:f="http://java.sun.com/jsf/core" xmlns:h="http://java.sun.com/jsf/html" xmlns:ice="http://www.icesoft.com/icefaces/component" xmlns:jsp="http://java.sun.com/JSP/Page">
    ...
    <f:view>
        <html id="outputHtml1">
            <head id="outputHead1">
                <title>Employee Provision Report</title>
                ...
                <script type="text/javascript">
                    var ProbationEmployee=jQuery.noConflict();
                    var element = document.getElementById("[id='form1:dataTable1']");
                    var asInitVals = new Array();
                    ProbationEmployee(document).ready(function () {
                        var oTable = ProbationEmployee("[id='form1:dataTable1']").dataTable({
                        ...
                        ProbationEmployee("tfoot input").keyup( function () {
                            /* Filter on the column (the index) of this element*/
                            oTable.fnFilter( this.value, ProbationEmployee("tfoot input").index(this),true ,true,true);
                            //alert("Qaz");
                         ...
                         * the footer
                         */
                        ProbationEmployee("tfoot input").each( function (i) {
                            asInitVals[i] = this.value;
                        } );

                        ProbationEmployee("tfoot input").focus( function () {
                        ...
                        ProbationEmployee("tfoot input").blur( function (i) {
                            if ( this.value == "" )
                            {
                                this.className = "search_init";
                                this.value = asInitVals[ProbationEmployee("tfoot input").index(this)];
                            }
                        } );
                    });
                </script>
            ...
            <body id="outputBody1" style="-rave-layout: grid">
                <ice:form id="form1">
                    <h:dataTable border="1" headerClass="list-header" id="dataTable1" rules="all"
                        rowClasses="list-row-even,list-row-odd iceMnuPopVrt iceMnuPopVrtItem iceMnuBarVrtItemLabel oddRow"
                        style="left: 24px; top: 120px; position: absolute" styleClass="display" value="#{Report$ProbationEmployee.personalInfoReport}" var="currentRow">
                        <h:column id="column1">
