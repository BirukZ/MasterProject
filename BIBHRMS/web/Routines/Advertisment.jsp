            ...
            <body id="outputBody1" style="-rave-layout: grid">
                <h:form id="form1">
                    <h:dataTable headerClass="list-header" id="dataTable1" rowClasses="list-row-even,list-row-odd"
                        ...
                        value="#{Routines$Advertisment.advertismentReportList}" var="currentRow">
                        <h:column id="column4">
                        ...
                        <h:column id="column16">
                            <h:outputText id="outputText34" value="#{currentRow['advertDateFrom']}"/>
                            <f:facet name="header">
                                <h:outputText id="outputText35" value="Advertismen From"/>
                            </f:facet>
                        </h:column>
                        <h:column id="column116">
                            <h:outputText id="outputText314" value="#{currentRow['advertDateTo']}"/>
                            <f:facet name="header">
                                <h:outputText id="outputText315" value="Advertismen To"/>
                            </f:facet>
                        </h:column>
