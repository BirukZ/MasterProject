...
import entity.disciplineEntity.DisciplineRequestReportEntity;
 ...
 */
public class DisciplineRequestReportManager {
       ReportEntity reportEntity = new ReportEntity();
       DisciplineRequestReportEntity requestReportEntity=new DisciplineRequestReportEntity();

    public ArrayList<HashMap> getDisciplineInfo() {
        try {
        ArrayList<HashMap> disciplineReportList = new ArrayList<HashMap>();
            OracleCachedRowSet ocrs = requestReportEntity.readAllDiscipline();
            while (ocrs.next()) {
                ...
                resultInfo.put("job_description", ocrs.getString("Requester_Job_Position"));
    ...
    public ArrayList<HashMap> getDisciplineInfoByMonth() {
        ...
        if (ReportCriteraManager.getParametrsForDay().get("selectedCodition").toString().equalsIgnoreCase("Monthly"))
            ...
            try {
             OracleCachedRowSet ocrs = requestReportEntity.readAllDisciplineByMonth(ReportCriteraManager.getParametrsForDay());
            ...
            try {
                OracleCachedRowSet ocrs = requestReportEntity.readAllDisciplineByQuarter(ReportCriteraManager.getParametrsForDay());
            ...
            try {
                OracleCachedRowSet ocrs = requestReportEntity.readAllDisciplineBySimiannual(ReportCriteraManager.getParametrsForDay());
                //   ArrayList<HashMap> disciplineReportList = new ArrayList<HashMap>();
                while (ocrs.next()) {
                    HashMap resultInfo = new HashMap();
                    resultInfo.put("Requester_ID", ocrs.getString("Requester_ID"));
            ...
            try {
                OracleCachedRowSet ocrs = requestReportEntity.readAllDisciplineByAnnual(ReportCriteraManager.getParametrsForDay());
                //  ArrayList<HashMap> disciplineReportList = new ArrayList<HashMap>();
                while (ocrs.next()) {
                    HashMap resultInfo = new HashMap();
                    resultInfo.put("Requester_ID", ocrs.getString("Requester_ID"));
            ...
            try {
                OracleCachedRowSet ocrs = requestReportEntity.readAllDisciplineByDays(ReportCriteraManager.getParametrsForDay());
                //   ArrayList<HashMap> disciplineReportList = new ArrayList<HashMap>();
                while (ocrs.next()) {
                    HashMap resultInfo = new HashMap();
                    resultInfo.put("Requester_ID", ocrs.getString("Requester_ID"));
