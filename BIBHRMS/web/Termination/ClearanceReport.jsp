        ...
        <html id="outputHtml1">
           <head id="outputHead1">
            ...
            <body id="outputBody1" style="-rave-layout: grid">
                <ice:form id="form1">
                    <ice:dataTable border="1"  headerClass="iceDatTblHdr displayHdr list-header" id="dataTable1"
                        rowClasses="list-row-even,list-row-odd" style="left: 38px; top: 86px; position: absolute" styleClass="iceDatTbl display"
                        value="#{Termination$ClearanceReport.cleranceList}" var="currentRow">
                        ...
                        <ice:column id="clmnedpartement1">
                            <h:outputText id="outputText4" value="#{currentRow['age']}"/>
                            <f:facet name="header">
                                <ice:outputText id="colDepartement1" style="font-family: 'Visual Geez Unicode'; font-size: 12px" value="ዕድሜ"/>
                            </f:facet>
                        </ice:column>
                        ...
                        <ice:column id="clmnTermId1">
                            <ice:outputText id="outputText6" value="#{currentRow['salary']}"/>
                            <f:facet name="header">
                                <ice:outputText id="colTerId1" style="font-family: 'Visual Geez Unicode'; font-size: 12px" value="ደመወዝ"/>
                            </f:facet>
                        </ice:column>
                        <ice:column id="clmnTermName1">
                            <ice:outputText id="outputText7" value="#{currentRow['rank']}"/>
                            <f:facet name="header">
                                <ice:outputText id="colTermName1" style="font-family: 'Visual Geez Unicode'; font-size: 12px" value="ደረጃ"/>
                            </f:facet>
                        </ice:column>
                        <ice:column id="clmnSex1" style="width: 117px" >
                            <ice:outputText id="outputText8" value="#{currentRow['educLevel']}"/>
                            <f:facet name="header">
                                <ice:outputText id="colAcreeted1" style="font-family: 'Visual Geez Unicode'; font-size: 12px" value="የትምህርት ደረጃ"/>
                            </f:facet>
                        </ice:column>
                        ...
                        <ice:column id="column1">
                            <ice:outputText id="outputText10" value="#{currentRow['reqDate']}"/>
                            <f:facet name="header">
                                <ice:outputText id="outputText11" style="font-family: 'Visual Geez Unicode'; font-size: 12px" value="የጠየቀበት  ቀን"/>
                            </f:facet>
                        </ice:column>
                        ...
                        <ice:column id="column3">
                            <ice:outputText id="outputText14" value="#{currentRow['reasonOfTermination']}"/>
                            <f:facet name="header">
                                <ice:outputText id="outputText15" style="font-family: 'Visual Geez Unicode'; font-size: 12px" value="የሚለቅበትምክንያት"/>
                            </f:facet>
                        </ice:column>
                        <ice:column id="column4">
                            <ice:outputText id="outputText16" value="#{currentRow['clearedDate']}"/>
                            <f:facet name="header">
                                <ice:outputText id="outputText17" style="font-family: 'Visual Geez Unicode'; font-size: 12px" value="ስንብቱ ተቀባይነት ያገኘበት ቀን "/>
                            </f:facet>
                        </ice:column>
