        ...
        <html id="outputHtml1">
            <head id="outputHead1">
                ...
                <script type="text/javascript">
                    var EmployeeTrainingReport=jQuery.noConflict();
            ...
            <body id="outputBody1" style="-rave-layout: grid">
                <ice:form id="form1">
                    <ice:dataTable headerClass="list-header" id="dataTable1" rowClasses="list-row-even,list-row-odd"
                        style="left: 24px; top: 120px; position: absolute" styleClass="display" value="#{Report$EmployeeTrainingReport.listOfTableDate}" var="currentRow">
                        ...
                        <ice:column id="colMugherExpriance">
                            <h:outputText id="lblMugherExpriance" value="#{currentRow['exprianceInMugher']}"/>
                            <f:facet name="header">
                                <h:outputText id="lblDisPlayMugherExpriance" style="font-family: 'Visual Geez Unicode'" value="የሙገር የሥራ ልምድ"/>
                            </f:facet>
                        </ice:column>
                        <ice:column id="colOtherExpriance">
                            <h:outputText id="lblOtherExpriance" value="#{currentRow['otherExpriance']}"/>
                            <f:facet name="header">
                                <h:outputText id="lblDisPlayOtherExpriance" style="font-family: 'Visual Geez Unicode'" value="የሌላ የሥራ ልምድ"/>
                            </f:facet>
                        </ice:column>
                          <ice:column id="colTraining">
                            <h:outputText id="lblTraining" value="#{currentRow['trainingName']}"/>
                            <f:facet name="header">
                                <h:outputText id="lblDisPlayTraining" style="font-family: 'Visual Geez Unicode'" value="ስልጠና"/>
                            </f:facet>
                        </ice:column>
