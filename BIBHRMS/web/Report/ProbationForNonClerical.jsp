        ...
        <html id="outputHtml1">
            <head id="outputHead1">
                ...
                <script type="text/javascript">
                    var ProbationForNonClerical=jQuery.noConflict();
                    var element = document.getElementById("[id='form1:dataTable1']");
                    var asInitVals = new Array();
                    ProbationForNonClerical(document).ready(function () {
                        var oTable = ProbationForNonClerical("[id='form1:dataTable1']").dataTable({
                        ...
                        ProbationForNonClerical("tfoot input").keyup( function () {
                            /* Filter on the column (the index) of this element*/
                            oTable.fnFilter( this.value, ProbationForNonClerical("tfoot input").index(this),true ,true,true);
                            //alert("Qaz");
                         ...
                         * the footer
                         */
                        ProbationForNonClerical("tfoot input").each( function (i) {
                            asInitVals[i] = this.value;
                        } );

                        ProbationForNonClerical("tfoot input").focus( function () {
                        ...
                        ProbationForNonClerical("tfoot input").blur( function (i) {
                            if ( this.value == "" )
                            {
                                this.className = "search_init";
                                this.value = asInitVals[ProbationForNonClerical("tfoot input").index(this)];
                            }
                        } );
                    });
                </script>
            ...
            <body id="outputBody1" style="-rave-layout: grid">
                <ice:form id="form1">
                    <h:dataTable border="1" headerClass="list-header" id="dataTable1"
                        ...
                        style="left: 24px; top: 120px; position: absolute" styleClass="display" value="#{Report$ProbationForNonClerical.personalInfoReport}" var="currentRow">
                        <h:column id="column1">
