 ...
 */
public class EvaluationNavigation extends AbstractPageBean {
    private HtmlCommandButton buttonReport = new HtmlCommandButton();

    public HtmlCommandButton getButtonReport() {
        return buttonReport;
    }

    public void setButtonReport(HtmlCommandButton hcb) {
        this.buttonReport = hcb;
    }
    private HtmlCommandButton buttonEvaluationNavigatorResultResolve = new HtmlCommandButton();

    public HtmlCommandButton getButtonEvaluationNavigatorResultResolve() {
        return buttonEvaluationNavigatorResultResolve;
    }

    public void setButtonEvaluationNavigatorResultResolve(HtmlCommandButton hcb) {
        this.buttonEvaluationNavigatorResultResolve = hcb;
    }
    private HtmlCommandButton buttonEvaluationNavigatorResultDisplay = new HtmlCommandButton();

    public HtmlCommandButton getButtonEvaluationNavigatorResultDisplay() {
        return buttonEvaluationNavigatorResultDisplay;
    }

    public void setButtonEvaluationNavigatorResultDisplay(HtmlCommandButton hcb) {
        this.buttonEvaluationNavigatorResultDisplay = hcb;
    }
    private HtmlCommandButton buttonEvaluationNavigatorResult = new HtmlCommandButton();

    public HtmlCommandButton getButtonEvaluationNavigatorResult() {
        return buttonEvaluationNavigatorResult;
    }

    public void setButtonEvaluationNavigatorResult(HtmlCommandButton hcb) {
        this.buttonEvaluationNavigatorResult = hcb;
    }
    private HtmlCommandButton buttonEvaluationNavigatorSession = new HtmlCommandButton();

    public HtmlCommandButton getButtonEvaluationNavigatorSession() {
        return buttonEvaluationNavigatorSession;
    }

    public void setButtonEvaluationNavigatorSession(HtmlCommandButton hcb) {
        this.buttonEvaluationNavigatorSession = hcb;
    }
    private HtmlCommandButton buttonEvaluationNavigatorCriteria = new HtmlCommandButton();

    public HtmlCommandButton getButtonEvaluationNavigatorCriteria() {
        return buttonEvaluationNavigatorCriteria;
    }

    public void setButtonEvaluationNavigatorCriteria(HtmlCommandButton hcb) {
        this.buttonEvaluationNavigatorCriteria = hcb;
    }
...
//
    ...
    public String buttonSaveEC_action() {
        ...
        if (this.evaCriteriaOPt.isEmpty() == true) {
            ...
            if (chekSave == 1) {
                lblevaCriteriaFormMessage.setValue("The Evaluation Criteria record is successfully saved!");
                showConformationMsg(pnevaCriteriaMessage.getStyleClass().toString());
                clearComponents();
//            populateTable();
            } else {
                lblevaCriteriaFormMessage.setValue("Error Occured during saving .Please Try Again?");
                showConformationMsg(pnevaCriteriaMessage.getStyleClass().toString());
                clearComponents();
//            populateTable();
            }
    ...
    public String buttonEditEC_action() {
        ...
        if (selectedEvaCriteriaRow == -1) {
            lblevaCriteriaFormMessage.setValue("You have to select a record from the table!!!");
            showConformationMsg(pnevaCriteriaMessage.getStyleClass().toString());
        } else if (evaCriteriaOPt.isEmpty() == true && selectedEvaCriteriaRow != -1) {
            lblevaCriteriaFormMessage.setValue("The Table is Empty!");
            showConformationMsg(pnevaCriteriaMessage.getStyleClass().toString());
...
//        }
    ...
    public String buttonEvaluationNavigatorResultDisplay_action() {
        //return null means stay on the same page
        return "EvaluationResultDisplay";
    }

    public String buttonEvaluationNavigatorResultResolve_action() {
        //return null means stay on the same page
        return "EvaluationResultResolveComplain";
    }

    public String buttonReport_action() {
        //return null means stay on the same page
