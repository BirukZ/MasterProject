 ...
 * @author Bini
 */
public class IncrementSalaryReports extends AbstractPageBean {
    ...
    public void init() {
        ...
        setIncrementPayGradeManagerList(incPayGradeManager.selectEmpForIncReport());
    }
