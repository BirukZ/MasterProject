...
import manager.disciplineManager.RejectedDisciplineReportManager;
 ...
 */
public class RejectedDisciplineReport extends AbstractPageBean {
     ...
     */
    public RejectedDisciplineReport() {
    }
  ...
  // populateDisiciplineTableComponentsByMonth(month);
   ...
   RejectedDisciplineReportManager reportManager=new RejectedDisciplineReportManager();
    ...
    // populateDisiciplineTableComponentsByMonth(month)
      ...
      private boolean populateCourseTableComponents() {
       ...
       private boolean populateDisiciplineTableComponentsByMonth() {
         ...
         ArrayList<HashMap> disciplineHashMap = reportManager.getDisciplineInfoByMonth();
        if (disciplineHashMap != null) {
            tableSize = 0;
