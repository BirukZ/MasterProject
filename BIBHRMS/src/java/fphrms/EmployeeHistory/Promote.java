 ...
 */
public class Promote extends AbstractPageBean {
    ...
    private void _init() throws Exception {
          panelCollapsibleHistory.setExpanded(true);
           panelCollapsible5.setExpanded(false);
        panelCollapsible5.addActionListener(new ActionListener() {

            public void processAction(ActionEvent ae) {
                panelCollapsible5_processAction(ae);
            }
        });
        panelCollapsibleHistory.addActionListener(new ActionListener() {

            public void processAction(ActionEvent ae) {
                panelCollapsibleHistory_processAction(ae);
            }
        });
    }
    ...
    private PanelCollapsible panelCollapsibleHistory = new PanelCollapsible();

    public PanelCollapsible getPanelCollapsibleHistory() {
        return panelCollapsibleHistory;
    }

    public void setPanelCollapsibleHistory(PanelCollapsible pc) {
        this.panelCollapsibleHistory = pc;
    }
    ...
    private PanelCollapsible panelCollapsible4 = new PanelCollapsible();

    public PanelCollapsible getPanelCollapsible4() {
        return panelCollapsible4;
    }

    public void setPanelCollapsible4(PanelCollapsible pc) {
        this.panelCollapsible4 = pc;
    }
...
//        this.setZerf(departmentManage.getDepartmentName());
        ...
        choDisplayOnPage.setSelected(true);
...
//      ..  this.inputTextSalaryActual.resetValue();
    ...
    public String btnPromote_action() {
        if (txtPromotionDate.getValue() != null) {
            if (!txtPromotionDate.getValue().toString().equals("")) {
                ...
                showSuccessOrFailureMessage(false, "You Must Inser Promotion Date?");
            }
        } else {
            showSuccessOrFailureMessage(false, "You Must Inser Promotion Date?");
        }
    ...
    public String changeTostring(String value) {
        if (value == null) {
            return " ";
        } else {
...
//            numberOfEmployeesPromoted = Integer.valueOf(date[3].trim());
    ...
    void viewOnReport(String employeeId) {
        try {
            ...
            DepartmentManage departmentManage = new DepartmentManage();
//        File jasperLocation = new File("E:\\FEDERALREPORTS\\Employee\\PersonalRecord.jasper");
            String jasperLocation = "E:\\FEDERALREPORTS\\Promotion\\EmployeePromotionDetail.jasper";
            ...
            for (HashMap hm : employeePromotionReportData) {//
                ...
                subMap.put("rank", hm.get("rank_From").toString());
                subMap.put("newRank", hm.get("rank_To").toString());
            ...
            departmentDescription = employeeManager.departmentDetileDescription(employeeManager.getDepartmentId());
...
//GenerateReport HttpServletRequest request, Map parameters, JRMapCollectionDataSource data)
    ...
    void loadEmployeeProfile(String employeeId) {
        ...
        try {
            ...
            txtWorkingPlace.setValue(employeeManager.getDepartmentId());
            ...
            int expYear = employeeManager.calculateEmpServiceYears(employeeId);
    ...
    void enabelPromotionComponets() {
        ...
        lblSalary.setValue("");
        txtWorkingPlace.setDisabled(false);
    ...
    void disabelPromotionComponets() {
        ...
        lblSalary.setValue("");
        txtWorkingPlace.setDisabled(true);
...
//            evaResultPopUpMsg.setRendered(false);
    ...
    public String btnReport_action() {
        if (getPromotioin_id() != null) {
            HashMap param = new HashMap();
            String jasperLocation = "E:\\FEDERALREPORTS\\Employee\\EmployeePromotion.jasper";
    ...
    public void panelCollapsible5_processAction(ActionEvent ae) {
        panelCollapsibleHistory.setExpanded(false);
        panelCollapsible5.setExpanded(true);
    }

    public void panelCollapsibleHistory_processAction(ActionEvent ae) {
        panelCollapsibleHistory.setExpanded(true);
        panelCollapsible5.setExpanded(false);
    }
}
