 ...
 */
public class EducationPaymentApprovePage extends AbstractPageBean {
...
// <editor-fold defaultstate="collapsed" desc="Alll">
    ...
    private void _init() throws Exception {
        ...
        educationPaymentApproveManager.setUserName(userName);
        educationPaymentApproveManager.setLoggedInEmployeeId(loggedInEmployeeId);
        requestListsToBeApproved = educationPaymentApproveManager.getRequestsToBeProcessed();
        requestHistoryList = educationPaymentApproveManager.getMyDecisionsOnRequests();
        availableDecisionsToMakeList = educationPaymentApproveManager.getAvailableDecisionsToMake(requestStatus);
    }
    ...
    private HtmlInputText txtDeciderFullName1 = new HtmlInputText();

    public HtmlInputText getTxtDeciderFullName1() {
        return txtDeciderFullName1;
    }

    public void setTxtDeciderFullName1(HtmlInputText hit) {
        this.txtDeciderFullName1 = hit;
    }
    private HtmlInputText txtDeciderDepartment1 = new HtmlInputText();

    public HtmlInputText getTxtDeciderDepartment1() {
        return txtDeciderDepartment1;
    }

    public void setTxtDeciderDepartment1(HtmlInputText hit) {
        this.txtDeciderDepartment1 = hit;
    }
    private HtmlInputText txtDeciderPosition1 = new HtmlInputText();

    public HtmlInputText getTxtDeciderPosition1() {
        return txtDeciderPosition1;
    }

    public void setTxtDeciderPosition1(HtmlInputText hit) {
        this.txtDeciderPosition1 = hit;
    }
    private HtmlInputText txtDeciderId1 = new HtmlInputText();

    public HtmlInputText getTxtDeciderId1() {
        return txtDeciderId1;
    }

    public void setTxtDeciderId1(HtmlInputText hit) {
        this.txtDeciderId1 = hit;
    }
    ...
    private javax.faces.component.html.HtmlSelectBooleanCheckbox checkbox = new javax.faces.component.html.HtmlSelectBooleanCheckbox();

    public javax.faces.component.html.HtmlSelectBooleanCheckbox getCheckbox() {
        return checkbox;
    }

    public void setCheckbox(javax.faces.component.html.HtmlSelectBooleanCheckbox hsbc) {
        this.checkbox = hsbc;
    }
     ...
     */
    public EducationPaymentApprovePage() {
    }
...
//    }
    ...
    public static void setSelected(boolean selected) {
        EducationPaymentApprovePage.selected = selected;
    }
    ...
    private void populateAllComponents(EducationPaymentModel educationRequestModel) {
//        populateRequesterTextComponents(educationRequestModel.getRequesterId());
        populateDecisionHistory(educationRequestModel.getEducationPaymentId());
//        populateEducationComponents(educationRequestModel.getEducationRequestId());
//        populatePaymentRequestTextComponents(educationRequestModel.getEducationPaymentId());
//        populateRequesterTableComponents(educationRequestModel.getEducationRequestId());
//        populateCourseTableComponents(educationRequestModel.getEducationRequestId());
    }

    private boolean populateRequesterTableComponents(int educatRequestId, String date) {

        ArrayList<HashMap> empInfoHashMap = educationPaymentApproveManager.getTableInfo(educatRequestId, date);
    ...
    private boolean populateCourseTableComponents(int educatRequestId, String date) {
        // int tableSize;
        ArrayList<HashMap> empInfoHashMap = educationPaymentApproveManager.getCourseInfo(educatRequestId, date);
        if (empInfoHashMap != null) {
            tableSize = 0;
            //    getAdminstrativeCostLists().clear();
            getCourseTakingList().clear();
...
//        txtDocumentReferenceNumber.setDisabled(true);
    ...
    public void clearRequestComponents() {
        txtSemesterOrTerm.setValue(null);
    ...
    private void makePageReadyForSave() {
        ...
        btnSaveOrUpdate.setValue("Save");
        btnSaveOrUpdate.setDisabled(false);
        drlDecision.setDisabled(false);
//        disableComponents();
        drlDecision.setDisabled(false);
        txtaDeciderComment.setDisabled(false);
    }

    private void makePageReadyForUpdate() {
//        enableComponents();
        newOrEditOrUpdateLabel = "Update";
        btnSaveOrUpdate.setValue("Update");
        btnSaveOrUpdate.setDisabled(false);
        drlDecision.setDisabled(true);
        txtaDeciderComment.setDisabled(true);
    }
    ...
    public void selectMyRequestLists_processValueChange(ValueChangeEvent vce) {
        try {
            ...
            educationPaymentModel = educationPaymentRequestManager.getEducationPaymentRequest(educationRequestId);
            //populateAllComponents(educationPaymentModel);
            populateRequesterTextComponents(requesterId);
    ...
    public void selectMyHistoryLists_processValueChange(ValueChangeEvent vce) {
        ...
        requestStatus = requestAttributes[3];
        appliedDate = requestAttributes[4];
        educationPaymentModel = educationPaymentRequestManager.getEducationPaymentRequest(educationPaymentRequestId);
        //  populateAllComponents(educationPaymentModel);
        populateRequesterTextComponents(requesterId);
        populateEducationComponents(educationRequestId);
        populatePaymentRequestTextComponents(educationPaymentRequestId);
...
//        makePageReadyForView();
    ...
    public String btnPopupOkDelete_action() {
        if (educationPaymentRequestManager.deleteEducationRequest(educationRequestId)) {
    ...
    private boolean validateDecision() {
        if (drlDecision.getValue().toString().equals(EducationPaymentApproveManager.EDUCATION_DECISION_NONE)) {
            showSuccessOrFailureMessage(false, "SELECT DECISION FIRST");
            return false;
        } else if (drlDecision.getValue().toString().equals(EducationPaymentApproveManager.EDUCATION_DECISION_REJECT) && (txtaDeciderComment.getValue() == null || txtaDeciderComment.getValue().toString().equals(""))) {
    ...
    public boolean saveDecision() {
        ...
        return educationPaymentApproveManager.saveDecision(educationPaymentRequestId, txtDeciderId1.getValue().toString(), drlDecision.getValue().toString(), requestStatus, comment);
    }
    ...
    public String btnSaveOrUpdate_action() {
        if (newOrEditOrUpdateLabel.equalsIgnoreCase("Save")) {
            ...
            if (educationPaymentApproveManager.updateReciptNumber(educationPaymentRequestId, txtDocumentReferenceNumber.getValue().toString(), txtReciptNumber.getValue().toString())) {
    ...
    private boolean populateApproverTextComponents(String approverId) {
        ...
        if (empInfoHashMap != null) {
            if (empInfoHashMap.get("employeeId").toString().equals("")) {//if no resultset found
                ...
                txtDeciderId1.setDisabled(false);
                return false;
            } else {
                approverId = empInfoHashMap.get("employeeId").toString();

                txtDeciderDepartment1.setValue(empInfoHashMap.get("employeeDepartmentName"));
                txtDeciderFullName1.setValue(empInfoHashMap.get("employeeFullName"));
                txtDeciderId1.setValue(empInfoHashMap.get("employeeId"));
                txtDeciderPosition1.setValue(empInfoHashMap.get("employeePosition"));
                return true;
            }
