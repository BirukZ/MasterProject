...
//
 ...
 public HashMap readAgreement(String employeeId) throws SQLException {
        String qry = "select educ_requ_id from hr_educ_agrement_duty where requester_id = '"+ employeeId + "'";
        HashMap data = new HashMap();
        try {
            _con = getConnection();
            _ps = _con.prepareStatement(qry);
