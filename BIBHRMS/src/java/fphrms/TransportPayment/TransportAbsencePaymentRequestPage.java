 ...
 */
public class TransportAbsencePaymentRequestPage extends AbstractPageBean {
    ...
    ArrayList<TransportPaymentsModel> serviceAbsentModelList2 = new ArrayList<TransportPaymentsModel>();
    ...
    String temporaryShift = null;
    int sundayOrHolyday = 0;
    ...
    public TransportAbsencePaymentRequestPage() {
    }
                ...
                if ((shName.equalsIgnoreCase("Shift")) || (shName.equalsIgnoreCase("Office")) || (shName.equalsIgnoreCase("null"))) {
                    ...
                    do {
                        ...
                        if ((checkHolidayButNotWeekend(strDate)) || (checkSunday(strDate))) {
                            sundayOrHolyday = transportAbsenceDateRegistrationManager.getAllsundayOrHolyday(empId, strDate);
                            if (sundayOrHolyday == 0) {
...
//                         
                            temporaryShift = transportAbsenceDateRegistrationManager.getAllWorkWithoutShift(empId, shCounter, strDate);
//                            if ((temporaryShift.equalsIgnoreCase("1"))||(temporaryShift.equalsIgnoreCase("2"))||(temporaryShift.equalsIgnoreCase("3"))) {
                            if (!(temporaryShift.equalsIgnoreCase("NO"))) {
                                tempShift = tempShift.concat(Integer.valueOf(temporaryShift).toString());
                                serviceAbsentModelList2 = transportAbsenceDateRegistrationManager.getAllTransportAbsenteDateList(serviceId, tempShift, strDate);
                                if (serviceAbsentModelList2.size() != 0) {
                                    empAbsenceDateList = transportAbsenceDatePaymentRequestManager.getAllEmployeeAbsenteDateList(empId, strDate);
                                    for (TransportPaymentsModel x : serviceAbsentModelList2) {
                                        if (x.getInOut().equalsIgnoreCase("BOTH")) {
                                            transportAbsenteDate = transportAbsenteDate + 1;
                                            if (empAbsenceDateList.size() != 0) {
                                                for (TransportPaymentsModel y : empAbsenceDateList) {
