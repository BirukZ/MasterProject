...
import manager.terminationManager.cleranceReportModel;
import manager.terminationManager.CleranceReportManager;
 ...
 */
public class ClearanceReport extends AbstractPageBean {
    ...
    public ArrayList<cleranceReportModel> getCleranceList() {
        return cleranceList;
    }

    public void setCleranceList(ArrayList<cleranceReportModel> cleranceList) {
        this.cleranceList = cleranceList;
    }

    

    public CleranceReportManager getCleranceReportManager() {
        return cleranceReportManager;
    }

    public void setCleranceReportManager(CleranceReportManager cleranceReportManager) {
        this.cleranceReportManager = cleranceReportManager;
    }
    ...
    CleranceReportManager cleranceReportManager = new CleranceReportManager();
    ArrayList<cleranceReportModel> cleranceList = new ArrayList<cleranceReportModel>();
    String reqId;
    String reqName;
    String sex;
    int age;
    ...
    private boolean populateCleranceTableComponents() {
        ...
        if (empInfoHashMap != null) {
            ...
            for (HashMap hmTc : empInfoHashMap) {
                ...
                rank = hmTc.get("rank_description").toString();
                educLevel = hmTc.get("description").toString();
                reqDate = hmTc.get("reqDate").toString();
                reasonOfTermination = hmTc.get("clearance_reason").toString();
                ...
                cleranceList.add(new cleranceReportModel(reqId, reqName, sex, age, salary, departement, postion, rank, educLevel,reqDate,reasonOfTermination,terminationAcceptan,clearedDate, finishedUnfin));
                tableSize++;
            }
            return true;
        } else {
