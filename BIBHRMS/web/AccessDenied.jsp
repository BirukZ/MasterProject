                            ...
                            <ice:panelGroup id="page_display" style="height: 393px">
                                <ice:panelLayout id="container" layout="flow"
                                    ...
                                    <ice:panelLayout id="pnlError" style="height: 226px; margin-left: 250px; left: -112px; top: 31px; position: absolute; width: 719px">
                                        <ice:commandLink action="#{AccessDenied.btnHome_action}" id="btnHome" immediate="true" style="background-image: url(Home.gif); background-repeat: repeat; font-family: 'Cambria'; font-size: 18px; font-style: normal; font-weight: bold; height: 50px; left: 304px; top: 209px; position: absolute; text-indent: 5px; vertical-align: middle; width: 53px; background-attachment: scroll"/>
                                        <ice:graphicImage id="graphicImage1" value="/resources/Biruk.png"/>
                                    </ice:panelLayout>
                                </ice:panelLayout>
                                <ice:panelLayout id="footer" style="background:none;height: 21px;top:25px; left: 0px; position: relative;font-family:Cambria;font-size:12px;font-weight:bold;text-align:center">
                                    <label
                                            style="margin-left:10px;color:#4A845E;font-weight:bold;font-family:Cambria">Copyright © 2005-2006 Ethiopian Calander | <a
                                            href="http://www.bunnabanksc.com" style="text-decoration:none;color:#D4B572">Bunna International Bank |Information System Department |Software Division.</a> |</label>
                                </ice:panelLayout>
                            </ice:panelGroup>
                        </f:facet>
                    </ice:panelBorder>
