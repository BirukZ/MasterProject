    ...
    <f:view>
        ...
        <html id="outputHtml1">
            ...
            <body id="outputBody1" style="-rave-layout: grid">
                <ice:form id="form1">
                    <div>
                        <ice:panelBorder id="whole_page" renderCenter="#{TransportPayment$AssignEmployeeInlocationPage.panelBorder1Bean.renderCenter}"
                            renderEast="#{TransportPayment$AssignEmployeeInlocationPage.panelBorder1Bean.renderEast}"
                            renderNorth="#{TransportPayment$AssignEmployeeInlocationPage.panelBorder1Bean.renderNorth}"
                            renderSouth="#{TransportPayment$AssignEmployeeInlocationPage.panelBorder1Bean.renderSouth}"
                            renderWest="#{TransportPayment$AssignEmployeeInlocationPage.panelBorder1Bean.renderEast}" style="top: 0px; position: relative"
                                            ...
                                            <ice:panelCollapsible expanded="true" id="pnl_col_Common_Tasks" style="border:none">
                                                ...
                                                <ice:panelGrid id="commonTasksGroup_Grid11" width="100%">
                                                    ...
                                                    <ul style="list-style-type: none; list-style-image: none; list-style-position: outside; line-height: 174%;">
                                                        <li>
                                                            <ice:commandLink
                                                                action="#{TransportPayment$AssignEmployeeInlocationPage.lnkPayrollPeriodLists_action}"
                                                                id="lnkPayrollPeriodLists" immediate="true" style="color:#333333;font-weight:bold" value="Take Attendance "/>
                                                        </li>
                                                        <li>
                                                            <ice:commandLink action="#{TransportPayment$AssignEmployeeInlocationPage.lnkPayrollGroup_action}"
                                                                id="lnkPayrollGroup" immediate="true" style="color:#333333;font-weight:bold" value="Approve Attendance"/>
                                                        </li>
                                                        <li>
                                                            <ice:commandLink
                                                                action="#{TransportPayment$AssignEmployeeInlocationPage.lnkPayrollEmployeeGroup_action}"
                                                ...
                                                <ice:panelGroup id="RetirementApproval" style="height: 700px" styleClass="filedset_border">
                                                    ...
                                                    <ice:panelLayout id="panelLayout1" style="border-width: 1px; border-style: solid; border-color: rgb(204, 204, 204) rgb(204, 204, 204) rgb(204, 204, 204) rgb(204, 204, 204); height: 358px; left: 40px; top: 230px; overflow: auto; position: absolute; width: 250px">
                                                        <ice:dataTable clientOnly="true" id="tblAvilableUsers" sortAscending="true" style="position: absolute"
                                                            value="#{TransportPayment$AssignEmployeeInlocationPage.availableEmployeeInDataModel}"
                                                    ...
                                                    <ice:panelLayout id="panelLayout2" style="border: 1px solid rgb(204, 204, 204); height: 358px; left: 490px; top: 230px; overflow: auto; position: absolute; width: 250px">
                                                        <ice:dataTable binding="#{TransportPayment$AssignEmployeeInlocationPage.tblAssgnedUsers}"
                                                            clientOnly="true" id="tblAssgnedUsers" style="position: absolute"
                                                            value="#{TransportPayment$AssignEmployeeInlocationPage.avilableEmployeeInGroup}" var="currentRow" width="100%">
                                                    ...
                                                    <ice:commandButton action="#{TransportPayment$AssignEmployeeInlocationPage.btnAdd_action}"
                                                        binding="#{TransportPayment$AssignEmployeeInlocationPage.btnAdd}" id="btnAdd"
                                                        style="left: 360px; top: 300px; position: absolute; width: 50px" value="[ &gt; ]"/>
                                                    <ice:commandButton action="#{TransportPayment$AssignEmployeeInlocationPage.btnRemove_action}"
                                                        binding="#{TransportPayment$AssignEmployeeInlocationPage.btnRemove}" id="btnRemove"
                                                        style="left: 360px; top: 340px; position: absolute; width: 50px" value="[ &lt; ]"/>
                                                    <ice:commandButton action="#{TransportPayment$AssignEmployeeInlocationPage.btnAddAll_action}"
                                                        binding="#{TransportPayment$AssignEmployeeInlocationPage.btnAddAll}" id="btnAddAll"
                                                        style="left: 360px; top: 380px; position: absolute; width: 50px" value="[ &gt;&gt; ]"/>
                                                    <ice:commandButton action="#{TransportPayment$AssignEmployeeInlocationPage.btnRemoveAll_action}"
                                                        binding="#{TransportPayment$AssignEmployeeInlocationPage.btnRemoveAll}" id="btnRemoveAll"
                                                        style="left: 360px; top: 420px; position: absolute; width: 50px" value="[ &lt;&lt; ]"/>
                                                    <ice:commandButton action="#{TransportPayment$AssignEmployeeInlocationPage.btnSaveGroup_action}"
                                                        id="btnSaveGroup" style="left: 40px; top: 650px; position: absolute; width: 170px" value="#{msgTr.Save }"/>
                                                    <ice:outputText binding="#{TransportPayment$AssignEmployeeInlocationPage.lblDepartmentName}"
                                                    ...
                                                    <ice:selectOneMenu binding="#{TransportPayment$AssignEmployeeInlocationPage.drlLlocationId}"
                                                        ...
                                                        value="#{TransportPayment$AssignEmployeeInlocationPage.selectOneMenu2Bean.selectedObject}" valueChangeListener="#{TransportPayment$AssignEmployeeInlocationPage.drlLlocationId_processValueChange}">
                                                        <f:selectItems id="selectOneMenu2selectItems" value="#{TransportPayment$AssignEmployeeInlocationPage.listOfLocation}"/>
                                                    </ice:selectOneMenu>
                                                    <ice:commandButton action="#{TransportPayment$AssignEmployeeInlocationPage.btnTree_action}" id="btnTree"
                                                        image="/Employee/images/pic3-tree-icon.jpg" style="left: 652px; top: 72px; position: absolute" value="submit"/>
                                                    <ice:commandButton action="#{TransportPayment$AssignEmployeeInlocationPage.btnAddEmployee_action}"
                                                        id="btnAddEmployee" style="left: 500px; top: 130px; position: absolute; width: 160px" value="#{msgTr.Add}"/>
                                                    <ice:commandButton action="#{TransportPayment$AssignEmployeeInlocationPage.button1_action}" id="button1"
                                                        style="left: 200px; top: 130px; position: absolute; width: 160px" value="#{msgTr.EmployeenotLocated}"/>
                                                </ice:panelGroup>
                                            </ice:panelLayout>
                                        </fieldset>
                                    </ice:panelLayout>
                        ...
                        <ice:panelPopup autoCentre="true" binding="#{TransportPayment$AssignEmployeeInlocationPage.pnMessage}" clientOnly="true"
                            ...
                            <f:facet name="header">
                                <ice:panelGroup id="pnlgridpnMessage" style="background-color:#333333; height: 20px; padding-top: 8px; width: 672px">
                                    ...
                                    <ice:commandLink action="#{TransportPayment$AssignEmployeeInlocationPage.modalPnlCloseMesssage_action}"
                            ...
                            <f:facet name="body">
                                <ice:panelGroup id="panelGroupMessage" style="display: block; height: 50px; position: relative; width: 638px" styleClass="icePnlGrp iceDatTblColHdr">
                                    <ice:panelLayout id="pnlMessageBody" layout="flow"
                                        ...
                                        <h:outputLabel binding="#{TransportPayment$AssignEmployeeInlocationPage.lblFormMessage1}" id="lblFormMessage1" style="background-color: #F5F5F5;"/>
                                    </ice:panelLayout>
                                </ice:panelGroup>
                            </f:facet>
                        </ice:panelPopup>
                        <ice:panelLayout binding="#{TransportPayment$AssignEmployeeInlocationPage.panelLayout3}" id="panelLayout3" layout="flow"
                            rendered="false"
                            ...
                            <ice:tree binding="#{TransportPayment$AssignEmployeeInlocationPage.tree1}" id="tree1"
                                style="height: 286px; margin-left: 0px; margin-top: 0px; text-align: left; width: 190px"
                                value="#{TransportPayment$AssignEmployeeInlocationPage.tree1Model.model}" var="item">
                                <ice:treeNode id="treeNode1">
                                    ...
                                    <f:facet name="content">
                                        <ice:panelGroup id="panelGroup2" style="display: inline;">
                                            <ice:commandLink actionListener="#{TransportPayment$AssignEmployeeInlocationPage.commandLink1_processAction}" id="commandLink1">
