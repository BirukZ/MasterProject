...
public class LeaveApproveManager {
    ...
    public boolean updateEmployeeAnualLeaveBalanceForLeaveWithOutPay(HashMap RegisterLeavWithOutPayInfo) {
        try {
            return leaveRequestEntity.updateLeaveBankForLeaveWithOutPay(RegisterLeavWithOutPayInfo);
        } catch (SQLException ex) {
            Logger.getLogger(LeaveApproveManager.class.getName()).log(Level.SEVERE, null, ex);
            return false;
        }
    }
