 ...
 */
public class Template extends AbstractPageBean  {
...
//            }
    ...
    private HtmlInputText txtLeaveAmount = new HtmlInputText();

    public HtmlInputText getTxtLeaveAmount() {
        return txtLeaveAmount;
    }

    public void setTxtLeaveAmount(HtmlInputText hit) {
        this.txtLeaveAmount = hit;
    }
...
//
    ...
    public String btnEditLeaveBalance_action() {
        ...
        txtLeaveAmount.setValue(leaveBalanceInfo.getAmount());
        ...
        if (this.isEmployeeMoreThatOneYear())
        {
            ...
            } else if (buttonIdentifierLeaveBalance == 3)
            {
                LeaveBalance leaveBalance = new LeaveBalance(
                        ...
                        Integer.parseInt(txtLeaveAmount.getValue().toString()),
                        lblFullName.getValue().toString(),
