 ...
 * @author tomgenial
 */
public class TransportPaymentReportEntity extends ConnectionManager {
    ...
    public ResultSet selectTransportPaymentApproved() throws SQLException {
        String _selectQuery = "SELECT req.EMPLOYEE_ID, " +
                ...
                "  req.E_ABSENT_DATE, " +
                "  req.TARIF_PER_DAY, " +
                "  req.PAYMENT_FOR_S_ABSENT, " +
                "  req.DAYS_IN_MONTH, " +
                "  req.TOTAL_E_ABSENT_DAYS, " +
                "  req.EXTRA_PAYMENT_PER_DAY, " +
                "  req.TOTAL_EXTRA_PAYMENT, " +
                "  req.TOTAL_PAYMENT, " +
                "  vw.department_path, " +
                "  vw.job_description, " +
                "  lists.REQUEST_DATE, " +
                "  lists.START_DATE, " +
                "  lists.END_DATE " +
                "FROM HR_TRANSPORT_PAYMENT_EMP_LIST req " +
                "INNER JOIN hr_employee_info info " +
                "ON info.emp_id=req.employee_id " +
                "INNER JOIN HR_TRANSPORT_PAYMENT_REQUEST lists " +
                "ON req.TRANSPORT_PAYMENT_REQUEST_ID=lists.TRANSPORT_PAYMENT_REQUEST_ID " +
...
//            _ps.setInt(3, institutionId);
    ...
    public ResultSet readAllTransportPaymentApprovedByMonth(HashMap list, String employeeId, boolean selectCriteria) throws SQLException {
        String _selectQuery = "SELECT req.EMPLOYEE_ID, " +
                "  info.FIRST_NAME " +
                "  ||info.MIDDLE_NAME " +
                "  ||info.LAST_NAME AS FULL_NAME, " +
                ...
                "INNER JOIN vw_employee_by_department_list vw " +
                "ON vw.emp_id=req.EMPLOYEE_ID " +
                "WHERE lists.REQUEST_STATUS  LIKE 'App-%' AND lists.REQUEST_STATUS NOT LIKE 'Rej-%' AND lists.TIME_STAMP LIKE '" + list.get("year") + "-%" + list.get("month") + "-%'";
...
//            _ps.setInt(3, institutionId);
    ...
    public ResultSet readAllTransportPaymentApprovedByQuarter(HashMap list, String employeeId, boolean selectCriteria) throws SQLException {
        ...
        String _selectQuery = "SELECT req.EMPLOYEE_ID, " +
                ...
                "INNER JOIN vw_employee_by_department_list vw " +
                "ON vw.emp_id=req.EMPLOYEE_ID " +
                "WHERE lists.REQUEST_STATUS  LIKE 'App-%' AND lists.REQUEST_STATUS NOT LIKE 'Rej-%' AND   to_date(subStr(lists.TIME_STAMP,1,10),'YYYY-MM-DD')" +
...
//            _ps.setInt(3, institutionId);
    ...
    public ResultSet readAllTransportPaymentApprovedByDays(HashMap list, String employeeId, boolean selectCriteria) throws SQLException {
        String _selectQuery = "SELECT req.EMPLOYEE_ID, " +
                "  info.FIRST_NAME " +
                "  ||info.MIDDLE_NAME " +
                "  ||info.LAST_NAME AS FULL_NAME, " +
...
//            _ps.setInt(3, institutionId);
    ...
    public ResultSet readAllTransportPaymentApprovedBySimiannual(HashMap list, String employeeId, boolean selectCriteria) throws SQLException {
...
//            _ps.setInt(3, institutionId);
    ...
    public ResultSet readAllTransportPaymentApprovedByAnnual(HashMap list, String employeeId, boolean selectCriteria) throws SQLException {
        String _selectQuery = "SELECT req.EMPLOYEE_ID, " +
                "  info.FIRST_NAME " +
                "  ||info.MIDDLE_NAME " +
                "  ||info.LAST_NAME AS FULL_NAME, " +
                ...
                "INNER JOIN vw_employee_by_department_list vw " +
                "ON vw.emp_id=req.EMPLOYEE_ID " +
                "WHERE lists.REQUEST_STATUS  LIKE 'App-%' AND lists.REQUEST_STATUS NOT LIKE 'Rej-%' AND lists.TIME_STAMP LIKE '" + list.get("year") + "-%-%'";
        if (!selectCriteria) {
             _selectQuery += " AND req.EMPLOYEE_ID         ='" + employeeId + "' " +
                    " ORDER BY req.EMPLOYEE_ID";
        } else {
...
//                "WHERE TR.PAYMENT_PAYE_BY LIKE 'MCE%' " +
...
//
//                "FROM HR_EMP_TRAINING TR " +
//                "WHERE TR.PAYMENT_PAYE_BY LIKE 'MCE%' AND TR.START_YEAR = '" + list.get("year") + "' AND TR.START_MONTH = '" + list.get("month") + "'" +
//                "GROUP BY  (TR.TRAININGORCOURSE_NAME)";
//        if (!selectCriteria) {
...
//                " BETWEEN TO_DATE(? ,'YYYY-MM-DD') " +
//                " AND TO_DATE(? ,'YYYY-MM-DD'))  AND (TR.PAYMENT_PAYE_BY LIKE 'MCE%') AND TR.START_YEAR = '" + list.get("year") + "'" +
//                "GROUP BY  (TR.TRAININGORCOURSE_NAME)";
//        if (!selectCriteria) {
//             _selectQuery += " ORDER BY TR.TRAININGORCOURSE_NAME desc";
//
...
//"  SUM(PAYMENT_FOR_TRAINING) TOTAL_COST " +
//"FROM HR_EMP_TRAINING TR " +
//"WHERE TR.PAYMENT_PAYE_BY LIKE 'MCE%' AND TR.START_YEAR = '" + list.get("year") + "' " +
//"GROUP BY (TRAININGORCOURSE_NAME)";
//        if (!selectCriteria) {
//             _selectQuery += " ORDER BY TR.TRAININGORCOURSE_NAME desc";
//
...
//"WHERE TR.PAYMENT_PAYE_BY = 'MCE' AND TR.START_YEAR = '" + list.get("year") + "' AND TR.START_MONTH = '" + list.get("month") + "'" +
//" GROUP BY  (TR.TRAININGORCOURSE_NAME)";
//        if (!selectCriteria) {
//             _selectQuery += " ORDER BY TR.TRAININGORCOURSE_NAME desc";
//
...
//"WHERE TR.PAYMENT_PAYE_BY = 'MCE' AND TR.START_YEAR = '" + list.get("year") + "'" +
//"GROUP BY (TR.TRAININGORCOURSE_NAME)";
//        if (!selectCriteria) {
//             _selectQuery += " ORDER BY TR.TRAININGORCOURSE_NAME desc";
//
