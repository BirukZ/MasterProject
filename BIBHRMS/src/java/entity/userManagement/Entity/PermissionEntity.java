...
extends ConnectionManager implements Serializable {
    ...
    public int insert(String _name, String _desc) throws SQLException {
        ...
        String _insert = "INSERT INTO BIB.TBL_PERMISSION(CODE,PERMISSION_NAME, PERMISSION_DESCRIPTION) " +
                " VALUES(BIB.TBL_PERMISSION_SEQ.NEXTVAL,'" + _name + "', '" + _desc + "') ";
        try {
            _con = getConnection();
    ...
    public boolean update() throws SQLException {
        String _update = "UPDATE BIB.tbl_permission SET permission_name=?" +
 ...
 String _delete = "DELETE FROM BIB.tbl_permission WHERE code = ? ";
        try {
            _con = getConnection();
    ...
    public ResultSet selectPermissions() throws SQLException {
        String _select = "SELECT code, permission_name FROM BIB.tbl_permission" +
