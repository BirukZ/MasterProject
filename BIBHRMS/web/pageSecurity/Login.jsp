        ...
        <html id="outputHtml1">
            <head id="outputHead1">
                ...
                <style>
                    ...
                    #login .forgot{text-align:left;font-size:11px;}
            ...
            <body id="outputBody1" style="-rave-layout: grid">
                ...
                <ice:form id="form1" onkeypress="return submitOnEnter(this,event);">
                    ...
                    <div id="login" >
                        <h1>Log  to  BUNNA BANK Human Resource Management System  !</h1>
                        <p class="register">
                        ...
                        <p class="back">
                            ...
                            <p class="forgot" >
                             <ice:commandLink action="#{pageSecurity$Login.hlkForgotyourpassword_action}"  id="hlkForgotyourpassword"
                                             immediate="true"
                                             value="Forgot your password ?" style="  text-decoration:underline;position:absolute;top:230px"/>
