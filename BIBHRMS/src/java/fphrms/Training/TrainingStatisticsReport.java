...
import manager.trainingManager.TrainingReportManager;
import manager.trainingManager.TrainingReportModel;
import fphrms.DocumentRequest.DocumentRequestPage;
import fphrms.Help.Template;
import fphrms.Termination.RetireApprovalPage;
import fphrms.Education.EducationPaymentApprovePage;
 ...
 */
public class TrainingStatisticsReport extends AbstractPageBean {
    ...
    TrainingReportManager trainingRequestManager = new  TrainingReportManager();
    ArrayList<TrainingReportModel> trainingStatisticsReport = trainingRequestManager.getTrainingStatistics();
    /**
     * <p>Construct a new Page bean instance.</p>
     */
    public TrainingStatisticsReport() {
    }

    public ArrayList<TrainingReportModel> getTrainingStatisticsReport() {
        return trainingStatisticsReport;
    }

    public void setTrainingStatisticsReport(ArrayList<TrainingReportModel> trainingStatisticsReport) {
        this.trainingStatisticsReport = trainingStatisticsReport;
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("TrainingStatisticsReport Initialization Failure", e);
     ...
     * @return reference to the scoped data bean
     */
    protected EducationPaymentApprovePage getEducation$EducationPaymentApprovePage() {
        return (EducationPaymentApprovePage) getBean("Education$EducationPaymentApprovePage");
    }
