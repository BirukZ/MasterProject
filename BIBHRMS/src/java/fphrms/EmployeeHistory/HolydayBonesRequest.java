 ...
 */
public class HolydayBonesRequest extends AbstractPageBean {
    ...
    public void init() {
        ...
        super.init();
        religionName = holydayBonesManager.getReligionList();
        txtBonesAmount.setValue(holydayBonesManager.bonesAmount());
        txtBonesAmount.setDisabled(true);
//        setHolydayBonesManagerList(holydayBonesManager.selectEmpForHolydayBonesManager());
    ...
    public void calReferenceDate_processValueChange(ValueChangeEvent vce) {
        ...
        txtDate.setValue(dateFormat.format(calReferenceDate.getValue()));
        calReferenceDate.setRendered(false);
    }

    public String buttonCalReferenceDate1_action() {
        calReferenceDate.setRendered(true);
        return null;
    }

    public void drlReligion_processValueChange(ValueChangeEvent vce) {
        holydayBonesManagerList.clear();
        religion = drlReligion.getValue().toString();
//        setHolydayBonesManagerList(holydayBonesManager.selectEmpForHolydayBonesManager(drlReligion.getValue().toString()));
    ...
    public String btnSave_action() {
        if (holydayBonesManager.request(religion, addressCode, txtBonesAmount.getValue().toString(), "requster", txtDate.getValue().toString(), txtHolydayName.getValue().toString(), holydayBonesManagerList)) {
            this.showSuccessOrFailureMessage(true, "Holyday Bones request is successfully saved!");
        }else{this.showSuccessOrFailureMessage(true, "Holyday Bones is successfully saved!");}
        return null;
    }
