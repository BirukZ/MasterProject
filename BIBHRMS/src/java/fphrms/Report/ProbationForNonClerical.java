 ...
 */
public class ProbationForNonClerical extends AbstractPageBean {
     ...
     */
    public ProbationForNonClerical() {
    }
       ...
       private boolean populatePersonalInfo()
       {
        ...
        if (employeeProfile != null) {
            ...
            for (HashMap hmDl : employeeProfile) {
               ...
               int rankClirical=Integer.parseInt(hmDl.get("RANK").toString());
               if((date<=40)&&(rankClirical<=4))
               {
