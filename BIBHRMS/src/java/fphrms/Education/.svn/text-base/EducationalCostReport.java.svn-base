 ...
 */
public class EducationalCostReport extends AbstractPageBean {
    ...
    private boolean populateCourseTableComponents() {
        // int tableSize;
        ArrayList<HashMap> empInfoHashMap = null;// reportManager.getApprovedEduc();
        ...
        if (empInfoHashMap != null) {
            ...
            for (HashMap hmTc : empInfoHashMap) {
                ...
                institutionAccredited = hmTc.get("INSTITUTION_ACCREDITED").toString();
