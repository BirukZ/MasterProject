...
import entity.powerDeligationEntity.PowerDeligationApproveReportEntity;
 ...
 * @author Biruk
 */
public class PowerDelegationApproveReportManager {

      PowerDeligationApproveReportEntity powerReportEntity = new PowerDeligationApproveReportEntity();
    ...
    public ArrayList<HashMap> getReportList() {
        try {
           ...
           public ArrayList<HashMap> getPowerDelegationApproveReportList() {
        ...
        try {
            ...
            OracleCachedRowSet ocrs = powerReportEntity.readAllPowerDelegationApprovedMontly(ReportCriteraManager.getParametrsForDay());
            while (ocrs.next()) {
                HashMap resultInfo = new HashMap();
                resultInfo.put("start_date", ocrs.getString("start_date"));
                resultInfo.put("end_date", ocrs.getString("end_date"));
     ...
     try {
            ...
            OracleCachedRowSet ocrs = powerReportEntity.readAllPowerDelegationApprovedSimannualy(ReportCriteraManager.getParametrsForDay());
            while (ocrs.next()) {
                HashMap resultInfo = new HashMap();
                resultInfo.put("start_date", ocrs.getString("start_date"));
                resultInfo.put("end_date", ocrs.getString("end_date"));
     ...
     try {
            ...
            OracleCachedRowSet ocrs = powerReportEntity.readAllPowerDelegationApprovedAnnulay(ReportCriteraManager.getParametrsForDay());
            while (ocrs.next()) {
                HashMap resultInfo = new HashMap();
                resultInfo.put("start_date", ocrs.getString("start_date"));
                resultInfo.put("end_date", ocrs.getString("end_date"));
