 ...
 */
public class EducationRequestReportPage extends AbstractPageBean {
     ...
     */
    public EducationRequestReportPage() {
    }
    ...
    private boolean populateCourseTableComponents() {
        // int tableSize;
        ArrayList<HashMap> empInfoHashMap = reportManager.getCourseInfo();
        if (empInfoHashMap != null) {
            ...
            for (HashMap hmTc : empInfoHashMap) {
              ...
              //  result = hmTc.get("result").toString();
                ...
                educationRequsetList.add(new ReportModel(requesterId, requesterName, age , sex, hireDate, jobPostion, dpartement,team,location,currentEducation,currentEducationrank,result, requestedEducation, requestedEuctionrank,institutionName,appliedDate, institutionAccredited,educationShiftCategory));
                tableSize++;
                    }
            return true;
        } else {
