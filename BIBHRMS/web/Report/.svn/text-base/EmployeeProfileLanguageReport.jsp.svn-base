        ...
        <html id="outputHtml1">
            <head id="outputHead1">
                ...
                <script type="text/javascript">
                    var EmployeeProfileLanguageReport=jQuery.noConflict();
            ...
            <body id="outputBody1" style="-rave-layout: grid">
                <ice:form id="form1">
                    <ice:dataTable headerClass="list-header" id="dataTable1" rowClasses="list-row-even,list-row-odd"
                                   style="left: 24px; top: 120px; position: absolute" styleClass="display" value="#{Report$EmployeeProfileLanguageReport.listOfTableDate}" var="currentRow">
                        ...
                        <ice:column id="colLanguage">
                            <h:outputText id="lblLanguage" value="#{currentRow['languageDescription']}"/>
                            <f:facet name="header">
                                <h:outputText id="lblDisPlayLanguage" style="font-family: 'Visual Geez Unicode'" value="ቋንቋ"/>
                            </f:facet>
                        </ice:column>
