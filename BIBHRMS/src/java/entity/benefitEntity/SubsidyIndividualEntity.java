 ...
 * @author 
 */
public class SubsidyIndividualEntity extends ConnectionManager {
...
//
     ...
     *
     */
    public SubsidyIndividualEntity() {
    }
     ...
     * @param resignationTypeDescription
     */
    public SubsidyIndividualEntity(String resignationTypeDescription) {
        this.resignationTypeDescription = resignationTypeDescription;
    }
     ...
     * @param employeeResignPostId
     */
    public SubsidyIndividualEntity(String employeeResignRequestId, String employeeResignPostId) {
        this.employeeResignRequestId = employeeResignRequestId;
        this.employeeResignPostId = employeeResignPostId;
    }
     ...
     */
    public SubsidyIndividualEntity(String dateId, String date, String dateDescription) {
     ...
     * @param comment
     */
    public SubsidyIndividualEntity(String commentDate, String employeeId, String terminationRequestID, String comment) {
        this.commentDate = commentDate;
     ...
     * @param terminationTypeSelected
     */
    public SubsidyIndividualEntity(String employeePostId, String resignationtypeId, String resignationDateRequested, String terminationDate, String resignationDescription, int state, String terminationRequestID, String group_Setting, String terminationTypeSelected) {
        this.employeePostId = employeePostId;
     ...
     * @param state
     */
    public SubsidyIndividualEntity(String employeePostId, String resignationtypeId, String resignationDateRequested, String resignationDescription, int state) {
        this.employeePostId = employeePostId;
        this.terminationType = resignationtypeId;
        this.terminationDateRequested = resignationDateRequested;
        this.terminationDescription = resignationDescription;
     ...
     * @param terminationRequestID
     */
    public SubsidyIndividualEntity(String employeePostId, String resignationtypeId, String resignationDateRequested, String resignationDescription, int state, String terminationRequestID) {
        this.employeePostId = employeePostId;
        this.terminationType = resignationtypeId;
        this.terminationDateRequested = resignationDateRequested;
        this.terminationDescription = resignationDescription;
...
//                    _con.rollback(savePoint4);//roll back to the save point four if there is any error while saving the required informations.
     ...
     * @return
     */
    public ArrayList<SubsidyIndividualEntity> readResignRequests() {
        String _select = "SELECT termination_ID,emp_Id FROM hr_termination_request WHERE STATE='" + 0 + "'";



        ArrayList<SubsidyIndividualEntity> terminationEntity = new ArrayList<SubsidyIndividualEntity>();
        try {
            _con = connectionManager.getConnection();
            _ps = _con.prepareStatement(_select);
            _ps.executeQuery();
            ...
            while (_rs.next()) {
                SubsidyIndividualEntity userEntity = new SubsidyIndividualEntity(_rs.getString("termination_ID"), _rs.getString("emp_Id"));
     ...
     * @return
     */
    public ArrayList<SubsidyIndividualEntity> readProcessedResignRequests() {
        String _select = "SELECT termination_ID,emp_Id FROM hr_termination_request WHERE state!='" + 0 + "'";
        ArrayList<SubsidyIndividualEntity> terminationEntity = new ArrayList<SubsidyIndividualEntity>();
        try {
            _con = connectionManager.getConnection();
     ...
     * @return
     */
    public ArrayList<SubsidyIndividualEntity> searchEmployeeResignationRequestsById(String requestId) {
     ...
     * @return
     */
    public SubsidyIndividualEntity ReadTerminationDateSettings() {
        String _select = "SELECT * FROM HR_TERMINATION_DATE_SETTING";



        SubsidyIndividualEntity terminationComment = null;
        try {
            _con = connectionManager.getConnection();
            _ps = _con.prepareStatement(_select);
            _rs = _ps.executeQuery();
            _rs = _ps.getResultSet();
            if (_rs.next()) {
                terminationComment = new SubsidyIndividualEntity(_rs.getString("TERMINATION_DATE_ID"),
     ...
     * @return
     */
    public ArrayList<SubsidyIndividualEntity> ReadPaymentCenter() {
        ...
        try {
            ...
            _rs = _ps.getResultSet();
            while (_rs.next()) {
                SubsidyIndividualEntity userEntity = new SubsidyIndividualEntity(_rs.getString("PAYMENT_CENTER_ID"), _rs.getString("PAYMENT_CENTER_NAME"));
                terminationEntity.add(userEntity);
            }
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    public static class TerminationRequest extends SubsidyIndividualEntity {
