...
import entity.educationEntity.EducationPosPayReportEntity;
 ...
 * @author Admin
 */
public class EducationPosPayReportManager {
    EducationPosPayReportEntity educationPosPayReportEntity = new EducationPosPayReportEntity();
 public ArrayList<HashMap> getApprovedEduc() {
        ...
        if (ReportCriteraManager.getParametrsForDay().get("selectedCodition").toString().equalsIgnoreCase("Monthly")) {
            try {
                ...
                OracleCachedRowSet ocrs = educationPosPayReportEntity.readApprovedEducMOnthly(ReportCriteraManager.getParametrsForDay());
                while (ocrs.next()) {
            ...
            try {
                // OracleCachedRowSet ocrs = reportEntity.readApprovedEduc();
                OracleCachedRowSet ocrs = educationPosPayReportEntity.readApprovedEducQuarterly(ReportCriteraManager.getParametrsForDay());
                while (ocrs.next()) {
                    HashMap resultInfo = new HashMap();
                    resultInfo.put("emp_id", ocrs.getString("emp_id"));
                    resultInfo.put("FullName", ocrs.getString("FullName"));
            ...
            try {
                // OracleCachedRowSet ocrs = reportEntity.readApprovedEduc();
                OracleCachedRowSet ocrs = educationPosPayReportEntity.readApprovedEducSemiAnnualy(ReportCriteraManager.getParametrsForDay());
                while (ocrs.next()) {
                    HashMap resultInfo = new HashMap();
                    resultInfo.put("emp_id", ocrs.getString("emp_id"));
                    resultInfo.put("FullName", ocrs.getString("FullName"));
            ...
            try {
                // OracleCachedRowSet ocrs = reportEntity.readApprovedEduc();
                OracleCachedRowSet ocrs = educationPosPayReportEntity.readApprovedEducAnnualy(ReportCriteraManager.getParametrsForDay());
                while (ocrs.next()) {
                    HashMap resultInfo = new HashMap();
                    resultInfo.put("emp_id", ocrs.getString("emp_id"));
                    resultInfo.put("FullName", ocrs.getString("FullName"));
            ...
            try {
                OracleCachedRowSet ocrs = educationPosPayReportEntity.readApprovedEducDaily(ReportCriteraManager.getParametrsForDay());
                while (ocrs.next()) {
                    HashMap resultInfo = new HashMap();
                    resultInfo.put("emp_id", ocrs.getString("emp_id"));
                    resultInfo.put("FullName", ocrs.getString("FullName"));
