...
public class HolidaysManager {
     ...
     *
     */
    public static long meteneRabiet = 1874;
...
//            StringDateManipulation.getYear(StringDateManipulation.toDayInEc());
    ...
    public static int getYearOfCreation(String date) {
        int currentYear =
                StringDateManipulation.getYear(date);
        int yearOfCreation;
    ...
    public static String getNewYearDay(String date) {
        int day = (int) ((getYearOfCreation(date) + meteneRabiet) % 7);
        switch (day) {
            case 0:
                return "Monday";
            case 1:
    ...
    public static int getMetqi(String date) {
        if ((getWenber(date) * 19) < 30) {
            return (getWenber(date) * 19);
        } else {
            return (getWenber(date) * 19) % 30;
        }
    }
    ...
    public static String getBaeleMetqi(String date) {
        if (getMetqi(date) > 14) {
            ...
            return "01-" + String.valueOf(getMetqi(date)); //In Meskerem
        } else if (getMetqi(date) < 14) {
            setNeneweh("06");//Neneweh is in Yekatit
            return "02-" + String.valueOf(getMetqi(date)); // In Tikimt
        } else {
            return "3";
        }
...
//        Neneweh = String.valueOf(getMetqi(date) + getTewsacOfTheDay(getBaeleMetqi(date)));
    ...
    public static int getTinteOn(String date) {
        return (int) (((getYearOfCreation(date) + meteneRabiet) % 7) - 1);
    }
