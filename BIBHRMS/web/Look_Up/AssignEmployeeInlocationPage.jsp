    ...
    <f:view>
        <html id="outputHtml1">
            ...
            <body id="outputBody1" style="-rave-layout: grid">
                <ice:form id="form1">
                    <div>
                        <ice:panelBorder id="whole_page" renderCenter="#{Look_Up$AssignEmployeeInlocationPage.panelBorder1Bean.renderCenter}"
                            renderEast="#{Look_Up$AssignEmployeeInlocationPage.panelBorder1Bean.renderEast}"
                            renderNorth="#{Look_Up$AssignEmployeeInlocationPage.panelBorder1Bean.renderNorth}"
                            renderSouth="#{Look_Up$AssignEmployeeInlocationPage.panelBorder1Bean.renderSouth}"
                            renderWest="#{Look_Up$AssignEmployeeInlocationPage.panelBorder1Bean.renderEast}" style="top: 0px; position: relative"
                                            ...
                                            <ice:panelCollapsible expanded="true" id="pnl_col_Common_Tasks" style="border:none">
                                                ...
                                                <ice:panelGrid id="commonTasksGroup_Grid11" width="100%">
                                                    ...
                                                    <ul style="list-style-type: none; list-style-image: none; list-style-position: outside; line-height: 174%;">
                                                        <li>
                                                            <ice:commandLink action="#{Look_Up$AssignEmployeeInlocationPage.lnkPayrollPeriodLists_action}"
                                                                id="lnkPayrollPeriodLists" immediate="true" style="color:#333333;font-weight:bold" value="Take Attendance "/>
                                                        </li>
                                                        <li>
                                                            <ice:commandLink action="#{Look_Up$AssignEmployeeInlocationPage.lnkPayrollGroup_action}"
                                                                id="lnkPayrollGroup" immediate="true" style="color:#333333;font-weight:bold" value="Approve Attendance"/>
                                                        </li>
                                                        <li>
                                                            <ice:commandLink action="#{Look_Up$AssignEmployeeInlocationPage.lnkPayrollEmployeeGroup_action}"
                                        ...
                                        <fieldset class="filedset_css" style="height: 760px;">
                                            ...
                                            <ice:panelLayout id="pnProfile" style="height: 770px; left: 0px; top: -20px; position: absolute; width: 100%">
                                                <ice:panelGroup id="RetirementApproval" style="height: 700px" styleClass="filedset_border">
                                                    ...
                                                    <ice:outputText id="lblLocationName" style="font-family: Cambria; left: 40px; top: 29px; position: absolute" value="Location Name :"/>
                                                    <ice:panelLayout id="panelLayout1" style="border-width: 1px; border-style: solid; border-color: rgb(204, 204, 204) rgb(204, 204, 204) rgb(204, 204, 204) rgb(204, 204, 204); height: 358px; left: 40px; top: 230px; overflow: auto; position: absolute; width: 250px">
                                                        <ice:dataTable clientOnly="true" id="tblAvilableUsers" sortAscending="true" style="position: absolute"
                                                            value="#{Look_Up$AssignEmployeeInlocationPage.availableEmployeeInDataModel}" var="currentRow" width="100%">
                                                    ...
                                                    <ice:panelLayout id="panelLayout2" style="border: 1px solid rgb(204, 204, 204); height: 358px; left: 490px; top: 230px; overflow: auto; position: absolute; width: 250px">
                                                        <ice:dataTable binding="#{Look_Up$AssignEmployeeInlocationPage.tblAssgnedUsers}" clientOnly="true"
                                                            id="tblAssgnedUsers" style="position: absolute"
                                                            value="#{Look_Up$AssignEmployeeInlocationPage.avilableEmployeeInGroup}" var="currentRow" width="100%">
                                                    ...
                                                    <ice:outputText id="lblDepartment" style="font-family: Cambria; left: 40px; top: 72px; position: absolute" value="Employee Department:"/>
                                                    <ice:outputText id="outputText1" style="font-family: Cambria; left: 40px; top: 200px; position: absolute" value="Available  Employee  With Out Location"/>
                                                    <ice:outputText id="outputText3" style="font-family: Cambria; left: 490px; top: 200px; position: absolute" value="List of Employee  has location"/>
                                                    <ice:commandButton action="#{Look_Up$AssignEmployeeInlocationPage.btnAdd_action}"
                                                        binding="#{Look_Up$AssignEmployeeInlocationPage.btnAdd}" id="btnAdd"
                                                        style="left: 360px; top: 300px; position: absolute; width: 50px" value="[ &gt; ]"/>
                                                    <ice:commandButton action="#{Look_Up$AssignEmployeeInlocationPage.btnRemove_action}"
                                                        binding="#{Look_Up$AssignEmployeeInlocationPage.btnRemove}" id="btnRemove"
                                                        style="left: 360px; top: 340px; position: absolute; width: 50px" value="[ &lt; ]"/>
                                                    <ice:commandButton action="#{Look_Up$AssignEmployeeInlocationPage.btnAddAll_action}"
                                                        binding="#{Look_Up$AssignEmployeeInlocationPage.btnAddAll}" id="btnAddAll"
                                                        style="left: 360px; top: 380px; position: absolute; width: 50px" value="[ &gt;&gt; ]"/>
                                                    <ice:commandButton action="#{Look_Up$AssignEmployeeInlocationPage.btnRemoveAll_action}"
                                                        binding="#{Look_Up$AssignEmployeeInlocationPage.btnRemoveAll}" id="btnRemoveAll"
                                                        style="left: 360px; top: 420px; position: absolute; width: 50px" value="[ &lt;&lt; ]"/>
                                                    <ice:commandButton action="#{Look_Up$AssignEmployeeInlocationPage.btnSaveGroup_action}" id="btnSaveGroup"
                                                        style="left: 40px; top: 650px; position: absolute; width: 170px" value="Save "/>
                                                    <ice:outputText binding="#{Look_Up$AssignEmployeeInlocationPage.lblDepartmentName}" id="lblDepartmentName"
                                                    ...
                                                    <ice:selectOneMenu binding="#{Look_Up$AssignEmployeeInlocationPage.drlLlocationId}" id="drlLlocationId"
                                                        partialSubmit="true"
                                                        ...
                                                        value="#{Look_Up$AssignEmployeeInlocationPage.selectOneMenu2Bean.selectedObject}" valueChangeListener="#{Look_Up$AssignEmployeeInlocationPage.drlLlocationId_processValueChange}">
                                                        <f:selectItems id="selectOneMenu2selectItems" value="#{Look_Up$AssignEmployeeInlocationPage.listOfLocation}"/>
                                                    </ice:selectOneMenu>
                                                    <ice:commandButton action="#{Look_Up$AssignEmployeeInlocationPage.btnTree_action}" id="btnTree"
                                                        image="/Employee/images/pic3-tree-icon.jpg" style="left: 652px; top: 72px; position: absolute" value="submit"/>
                                                    <ice:commandButton action="#{Look_Up$AssignEmployeeInlocationPage.btnAddEmployee_action}"
                                                        id="btnAddEmployee" style="left: 500px; top: 130px; position: absolute; width: 160px" value="Add"/>
                                                    <ice:commandButton action="#{Look_Up$AssignEmployeeInlocationPage.button1_action}" id="button1"
                                                        style="left: 200px; top: 130px; position: absolute; width: 160px" value="Employee not Located"/>
                                                </ice:panelGroup>
                                            </ice:panelLayout>
                                        </fieldset>
                                    </ice:panelLayout>
                                ...
                                <ice:panelGroup id="page_footer">
                                    <ice:panelLayout id="footer" layout="flow" style="height: 21px; left: 0px; position: relative; -rave-layout: grid" styleClass="page_footer">
                                        <label
                                                ...
                                                href="http://www.bunnabanksc.com" style="margin-left:10px;color:#333333;">BUNNA INTERNATIONAL BANK |INFORMATION SYSTEM |Software Department.</a> |</label>
                                    </ice:panelLayout>
                                </ice:panelGroup>
                            </f:facet>
                        </ice:panelBorder>
                        <ice:panelPopup autoCentre="true" binding="#{Look_Up$AssignEmployeeInlocationPage.pnMessage}" clientOnly="true" draggable="false"
                            ...
                            <f:facet name="header">
                                <ice:panelGroup id="pnlgridpnMessage" style="background-color:#333333; height: 20px; padding-top: 8px; width: 672px">
                                    ...
                                    <ice:commandLink action="#{Look_Up$AssignEmployeeInlocationPage.modalPnlCloseMesssage_action}" id="modalPnlCloseMesssage"
                                        immediate="true"
                            ...
                            <f:facet name="body">
                                <ice:panelGroup id="panelGroupMessage" style="display: block; height: 50px; position: relative; width: 638px" styleClass="icePnlGrp iceDatTblColHdr">
                                    <ice:panelLayout id="pnlMessageBody" layout="flow"
                                        ...
                                        <h:outputLabel binding="#{Look_Up$AssignEmployeeInlocationPage.lblFormMessage1}" id="lblFormMessage1" style="background-color: #F5F5F5;"/>
                                    </ice:panelLayout>
                                </ice:panelGroup>
                            </f:facet>
                        </ice:panelPopup>
                        <ice:panelLayout binding="#{Look_Up$AssignEmployeeInlocationPage.panelLayout3}" id="panelLayout3" layout="flow" rendered="false"
                            ...
                            <ice:tree binding="#{Look_Up$AssignEmployeeInlocationPage.tree1}" id="tree1"
                                style="height: 286px; margin-left: 0px; margin-top: 0px; text-align: left; width: 190px"
                                value="#{Look_Up$AssignEmployeeInlocationPage.tree1Model.model}" var="item">
                                <ice:treeNode id="treeNode1">
                                    ...
                                    <f:facet name="content">
                                        <ice:panelGroup id="panelGroup2" style="display: inline;">
                                            <ice:commandLink actionListener="#{Look_Up$AssignEmployeeInlocationPage.commandLink1_processAction}" id="commandLink1">
