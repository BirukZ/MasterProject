...
public class ChangeInstitutionEntity extends ConnectionManager {
    ...
    public int insertEducationRequest(changeInstitutionRequestModel changeInsModel) throws SQLException {
        String _insertQuery = "INSERT INTO HR_CHANGE_INST_REQUEST " +
                ...
                " DOCUMENT_REFERENCE_NUMBER,REQUEST_STATUS,TIME_STAMP,USER_NAME,EDU_REQ_ID,END_DATE)" +
                " VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ";
        try {
            _con = getConnection();
    ...
    public int updateEducationRequest(changeInstitutionRequestModel changeInsModel) throws SQLException {
        ...
        try {
            ...
            _ps.setDouble(9, changeInsModel.getCostPerCreditHourNew());
            _ps.setInt(10, changeInsModel.getNumberOfCreditHoursNew());
            _ps.setDouble(11, changeInsModel.getTotalAdminstrationCostsNew());
            _ps.setString(12, changeInsModel.getDocumentReferenceNumberNew());
            _ps.setString(13, changeInsModel.getTimeStamp());
            _ps.setString(14, changeInsModel.getUserName());
            _ps.setString(15, changeInsModel.getRequestStatus());
            _ps.setString(16, changeInsModel.getRequesterId());
            _ps.setInt(17, changeInsModel.getEducationRequestId());
...
//==========================================================================================================
    ...
    public ResultSet selectEducationChangeInsRequest(String requesterId) throws SQLException {
        String _selectQuery = " SELECT * FROM HR_EDUCATION_REQUEST " +
                ...
                "and REQUESTER_ID = '"+ requesterId +"' ORDER BY APPLIED_DATE DESC";
        try {
            _con = getConnection();
            _ps = _con.prepareStatement(_selectQuery);
...
//            _ps.setString(2, userName);
    ...
    public int updateChangeInst(changeInstitutionRequestModel changeInsModel) throws SQLException {
        ...
        try {
            ...
            _ps.setDouble(9, changeInsModel.getCostPerCreditHour());
            _ps.setInt(10, changeInsModel.getNumberOfCreditHours());
            _ps.setDouble(11, changeInsModel.getTotalAdminstrationCosts());
            _ps.setString(12, changeInsModel.getDocumentReferenceNumber());
            _ps.setString(13, changeInsModel.getTimeStamp());
            _ps.setString(14, changeInsModel.getUserName());
            _ps.setString(15, changeInsModel.getEndDate());
            _ps.setInt(16, changeInsModel.getChangeInstId());
            _ps.setInt(17, changeInsModel.getEducationRequestId());
 ...
 public int updatePreviousChangeInst(changeInstitutionRequestModel changeInsModel) throws SQLException {
        String _updateQuery = "UPDATE HR_CHANGE_INST_REQUEST " +
                " SET " +
                " EDUCATION_PROGRAM_NAME = ?,EDUCATION_LEVEL_CATEGORY = ?,EDUCATION_SHIFT_CATEGORY = ?," +
                " START_DATE = ?, APPLIED_DATE = ?,DURATION_IN_YEAR = ?,REASON_DESCRIPTION = ?," +
