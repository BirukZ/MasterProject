 ...
 */
public class MainReportPage extends AbstractPageBean {
...
//        private DefaultTree tree1Model = new DefaultTree();
    ...
    private Tree trReport = new Tree();

    public Tree getTrReport() {
        return trReport;
    }

    public void setTrReport(Tree t) {
        this.trReport = t;
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("MainReportPage Initialization Failure", e);
