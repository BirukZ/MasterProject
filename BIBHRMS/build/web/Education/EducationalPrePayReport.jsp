...
<jsp:root version="2.1" xmlns:f="http://java.sun.com/jsf/core" xmlns:h="http://java.sun.com/jsf/html" xmlns:ice="http://www.icesoft.com/icefaces/component" xmlns:jsp="http://java.sun.com/JSP/Page">
    ...
    <f:view>
        <html id="outputHtml1">
            <head id="outputHead1">
                <title>Pre Payment Education</title>
            ...
            <body id="outputBody1" style="-rave-layout: grid">
                <ice:form id="form1">
                    <h:dataTable binding="#{Education$EducationalPrePayReport.dtbEducationRequestReport}" border="1" headerClass="list-header" id="dataTable1"
                        rowClasses="list-row-even,list-row-odd" style="left: 24px; top: 120px; position: absolute" styleClass="display"
                        value="#{Education$EducationalPrePayReport.educationRequsetList}" var="currentRow" width="384px">
                        <h:column id="clmnId">
