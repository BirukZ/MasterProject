 ...
 */
public class PromotionFilterCandidateReport extends AbstractPageBean {
...
//    RecruitmentReport promotionFilterCandidateReport = new RecruitmentReport();
     ...
     */
    public PromotionFilterCandidateReport() {
    }
    ...
    private void  populateParticipantTable() {
      //  promotionFilterReportList = promotionFilterCandidateReport.promotionFilterCandidate();
