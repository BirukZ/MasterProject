...
public class OverTimeAttendancePage extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        ...
        txtAttendDate.setValue(dateFormat.format(new Date()));
    }
    ...
    private HtmlInputText txtAttendDate = new HtmlInputText();

    public HtmlInputText getTxtAttendDate() {
        return txtAttendDate;
    }

    public void setTxtAttendDate(HtmlInputText hit) {
        this.txtAttendDate = hit;
    }
    ...
    public String btnSaveAttendance_action() {
        if (validateAttemdance()) {
            if (saveOrUpdateLabel.equals("Update")) {
                ...
                if (overTimeAttendanceManager.saveOverTimeAttendance(overTimeAttendanceEmployeeLists, userName, overTimeRequestId, txtAttendDate.getValue().toString())) {
    ...
    private boolean populateOverTimeRequestTextComponents(int overTimeRequestId) {
        ...
        if (overTimeRequestModel != null) {
            if (overTimeRequestModel.getoverTimeRequestId() != -1) {
                ...
                otRequestUserName = overTimeRequestModel.getOtRequestUserName();
