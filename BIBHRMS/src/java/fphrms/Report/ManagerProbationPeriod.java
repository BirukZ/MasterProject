 ...
 */
public class ManagerProbationPeriod extends AbstractPageBean {
    ...
    public void prerender() {
      //populateCourseTableComponents();
       ...
       populateProbationForManagement();
 ...
 EmployeePersonalInfo employeeProfileReportManager = new EmployeePersonalInfo();
       ...
       private boolean populatePersonalInfo()
       {
         ...
         ArrayList<HashMap> employeeProfile = employeeProfileReportManager.loadEmployeeProbationInformationForReport();
        if (employeeProfile != null) {
            tableSize = 0;
    
            for (HashMap hmDl : employeeProfile) {
               int date=Integer.parseInt(hmDl.get("EXPRIANCEINBIB").toString());
              // String jobLevel=hmDl.get("JOB_LEVEL").toString();
               if(date<=40)
               {
              ...
              //  eudcationLevel = hmDl.get("EDUCATIONLEVEL").toString();
               ...
               // otherExpirance = hmDl.get("OTHEREXPRIANCE").toString();
                ...
                jobDescription = hmDl.get("INSIDEeXPRIANCE").toString();
  ...
  private boolean populateProbationForManagement()
       {
        ...
        if (employeeProfile != null) {
            ...
            for (HashMap hmDl : employeeProfile) {
               int date=Integer.parseInt(hmDl.get("EXPRIANCEINBIB").toString());
               String jobLevel=hmDl.get("JOB_LEVEL").toString();
               if((date<=80) && (jobLevel.equalsIgnoreCase("MG")))
               {
                empID = hmDl.get("EMPLOYEEID").toString();
                empFullName = hmDl.get("FULLNAME").toString();
                age = Integer.parseInt(hmDl.get("AGE").toString());
