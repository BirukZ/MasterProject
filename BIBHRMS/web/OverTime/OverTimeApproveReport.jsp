...
<!-- 
    Document   : OverTimeApproveReport
    Created on : Jul 23, 2012, 11:53:28 AM
    Author     : tomgenial 
-->
<jsp:root version="2.1" xmlns:f="http://java.sun.com/jsf/core" xmlns:h="http://java.sun.com/jsf/html" xmlns:ice="http://www.icesoft.com/icefaces/component" xmlns:jsp="http://java.sun.com/JSP/Page">
    ...
    <f:view>
        <html id="outputHtml1">
            ...
            <head id="outputHead1">
                <title>Over Time Approve Report</title>
            ...
            <body id="outputBody1" style="-rave-layout: grid">
                <ice:form id="form1">
                    <h:dataTable border="1" headerClass="list-header" id="dataTable1" rowClasses="list-row-even,list-row-odd"
                        style="font-size: 10px; left: 0px; top: 216px; position: absolute" value="#{OverTime$OverTimeApproveReport.overTimeApproveReport}" var="currentRow">
                        ...
                        <h:column id="clmndeciderId">
                            <h:outputText id="outputText17" value="#{currentRow['deciderId']}"/>
                            <f:facet name="header">
                                <h:outputText id="deciderId" style="font-family: 'Visual Geez Unicode'; font-size: 12px" value="መለያ ቁጥር"/>
                            </f:facet>
                        </h:column>
                        <h:column id="clmndeciderFullName">
                            <h:outputText id="outputText18" value="#{currentRow['deciderFullName']}"/>
                            <f:facet name="header">
                                <h:outputText id="deciderFullName" style="font-family: 'Visual Geez Unicode'; font-size: 12px" value="ያጸደቀው ሥም"/>
                            </f:facet>
                        </h:column>
                        <h:column id="clmndeciderDeptPath">
                            <h:outputText id="outputText19" value="#{currentRow['deciderDeptPath']}"/>
                            <f:facet name="header">
                                <h:outputText id="deciderDeptPath" style="font-family: 'Visual Geez Unicode'; font-size: 12px" value="የሥራ መደብ"/>
                            </f:facet>
                        </h:column>
                        <h:column id="clmndeciderJobDesc">
                            <h:outputText id="outputText20" value="#{currentRow['deciderJobDesc']}"/>
                            <f:facet name="header">
                                <h:outputText id="deciderJobDesc" style="font-family: 'Visual Geez Unicode'; font-size: 12px" value="የሥራ ክፍል"/>
                            </f:facet>
                        </h:column>
                        <h:column id="clmntimeStamp">
                            <h:outputText id="outputText21" value="#{currentRow['timeStamp']}"/>
                            <f:facet name="header">
                                <h:outputText id="timeStamp" style="font-family: 'Visual Geez Unicode'; font-size: 12px" value="ቀን"/>
                            </f:facet>
                        </h:column>
                    </h:dataTable>
                </ice:form>
