...
import entity.educationEntity.EducationPrePayReportEntity;
 ...
 * @author Admin
 */
public class EducationPrePayReportManager {
    EducationPrePayReportEntity educationPrePayReportEntity = new EducationPrePayReportEntity();
 public ArrayList<HashMap> getApprovedEduc() {
        ...
        if (ReportCriteraManager.getParametrsForDay().get("selectedCodition").toString().equalsIgnoreCase("Monthly")) {
            try {
                ...
                OracleCachedRowSet ocrs = educationPrePayReportEntity.readApprovedEducMOnthly(ReportCriteraManager.getParametrsForDay());
                while (ocrs.next()) {
            ...
            try {
                // OracleCachedRowSet ocrs = reportEntity.readApprovedEduc();
                OracleCachedRowSet ocrs = educationPrePayReportEntity.readApprovedEducQuarterly(ReportCriteraManager.getParametrsForDay());
                while (ocrs.next()) {
                    HashMap resultInfo = new HashMap();
                    resultInfo.put("emp_id", ocrs.getString("emp_id"));
                    resultInfo.put("FullName", ocrs.getString("FullName"));
            ...
            try {
                // OracleCachedRowSet ocrs = reportEntity.readApprovedEduc();
                OracleCachedRowSet ocrs = educationPrePayReportEntity.readApprovedEducSemiAnnualy(ReportCriteraManager.getParametrsForDay());
                while (ocrs.next()) {
                    HashMap resultInfo = new HashMap();
                    resultInfo.put("emp_id", ocrs.getString("emp_id"));
                    resultInfo.put("FullName", ocrs.getString("FullName"));
            ...
            try {
                // OracleCachedRowSet ocrs = reportEntity.readApprovedEduc();
                OracleCachedRowSet ocrs = educationPrePayReportEntity.readApprovedEducAnnualy(ReportCriteraManager.getParametrsForDay());
                while (ocrs.next()) {
                    HashMap resultInfo = new HashMap();
                    resultInfo.put("emp_id", ocrs.getString("emp_id"));
                    resultInfo.put("FullName", ocrs.getString("FullName"));
            ...
            try {
                OracleCachedRowSet ocrs = educationPrePayReportEntity.readApprovedEducDaily(ReportCriteraManager.getParametrsForDay());
                while (ocrs.next()) {
                    HashMap resultInfo = new HashMap();
                    resultInfo.put("emp_id", ocrs.getString("emp_id"));
                    resultInfo.put("FullName", ocrs.getString("FullName"));
